...
function BgEclipse() {
    return (
        <div className="">
            <svg className='fixed left-[-40%] bottom-[25%] md:left-[-40%] md:bottom-[-30%] lg:left-[-30%] lg:bottom-[-40%] 2xl:left-[-15%] 2xl:bottom-[-40%] w-[500px] md:w-[1200px] h-[500px] md:w-[750px] lg:w-[850px]  md:h-[950px] 2xl:w-[1250px] 2xl:h-[1250px] -z-1' viewBox="0 0 1293 1294" fill="none" xmlns="http://www.w3.org/2000/svg">
